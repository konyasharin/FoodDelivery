...
export const BasketIcon: FC<IconProps> = ({ className, ...attributes }) => {
  return (
    <svg
      ...
      {...attributes}
    >
      <g clipPath="url(#clip15_68)">
        <path
          id="path"
          d="M7.5 10.5L5.53 10.5C4.18 10.5 3.14 11.67 3.29 13.01L5.33 30.17C5.42 30.93 6.06 31.5 6.82 31.5L29.6 31.5C30.37 31.5 31.02 30.91 31.09 30.14L32.76 12.96C32.88 11.64 31.85 10.5 30.52 10.5L28.5 10.5"
          stroke={'currentColor'}
